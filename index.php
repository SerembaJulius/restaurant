...
<html lang="en">
<head>
<title>OLULIMU COUNTRY RESORT</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@OLULIMU.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+25600-00-00</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">OLULIMU <span>RESORT</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>OLULIMU  <span>RESORT</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">OLULIMU</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our OLULIMU</h3> 
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon" >
										<div class="w3l-slider-img">
											<img src="images/about2.jpg" class="img-responsive" alt="Hair Salon" width="450px" height="450px" margin-top="300px">
										</div>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery1.jpg" class="swipebox"><img src="images/gallery1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery2.jpg" class="swipebox"><img src="images/gallery2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery3.jpg" class="swipebox"><img src="images/gallery3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery4.jpg" class="swipebox"><img src="images/gallery4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery5.jpg" class="swipebox"><img src="images/gallery5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery6.jpg" class="swipebox"><img src="images/gallery6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery7.jpg" class="swipebox"><img src="images/gallery7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery8.jpg" class="swipebox"><img src="images/gallery8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
					...
					<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery9.jpg" class="swipebox"><img src="images/gallery9.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/gallery.jpg" class="swipebox"><img src="images/gallery.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OLULIMU</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
      ...
      <div class="plans-section" id="rooms">
				 ...
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img src="images/gallery6.jpg" alt=" " class="img-responsive" />
							<h4>Deluxe Room</h4>
						</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+256000-00-00</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@OLULIMU.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Gulu, Uganda</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 EURIUS . All Rights Reserved | Design by <a href="index.php">EURIUS</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
